                    ...
                    <div className={styles.Login__contentContainer}>
                        ...
                        <form className={styles.Login__form} onSubmit={handleSubmit}>
                            <div className={styles.Login__formGroup}>
                                <input className={styles.Login__formInput} type="email" placeholder="Username or email" name="email" onChange={handleInputChange}/>
                            </div>
                            <div className={styles.Login__formGroup}>
                                <input className={styles.Login__formInput} type="password" placeholder="Password" name="password" onChange={handleInputChange}/>
                            </div>
