                ...
                <section className={styles.Register__sections__left}>
                    <div className={styles.Register__contentContainer}>
                        <h1 className={styles.Register__title}>
                            <span className={styles.Register__title__main}>
                                Sign up for an account
                            </span>
                            <span className={styles.Register__title__sub}>
                                Create new possiblities with us
                            </span>
                        </h1>
                        <form
                        ...
                        >
                            ...
                            <div className={styles.Register__formBottom}>
                                <button
                                    type="submit"
                                    className={styles.Register__formBtn}
                                >
                                    <span>Proceed</span>&nbsp;
                                    <Oval
                                        height={20}
                                ...
                                <p>
                                    ...
                                    our <strong>Privacy Policy</strong>, and{' '}
                                    <strong>
                ...
                <section className={styles.Register__sections__right}>
                    <div className={styles.Register__welcomeContainer}>
                        <h1 className={styles.Register__welcomeText}>
                            <span
                                className={styles.Register__welcomeText__main}
                            >
                                Welcome to Metics
                            </span>
                            <span className={styles.Register__welcomeText__sub}>
                                Redefining business comfort
                            </span>
                        </h1>
                        <ul className={styles.Register__welcomeList}>
                            <li className={styles.Register__welcomeListItem}>
                                Make your digital presence standout with our
                                unshakable partner network
                            </li>
                            <li className={styles.Register__welcomeListItem}>
                                Grow exponentially with Metics Hub stretching to
                                new horizons and global network
                            </li>
                            <li className={styles.Register__welcomeListItem}>
                                Always partner first approach serves you with
                                un-beatable growth and customer support
                            </li>
                        </ul>
                    </div>
                </section>
